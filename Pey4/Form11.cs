...
namespace Pey4
{
    public partial class Form11 : Form
    {
        ...
        private void Form11_Load(object sender, EventArgs e)
        {
            ...
            database.Connection_Open();
            database.Fill("SELECT * FROM AccountingCode", objDataSet, "AccountingCode", true);
            database.Connection_Close();

            dataGridView1.AutoGenerateColumns = true;
            dataGridView1.DataSource = objDataSet;
            dataGridView1.DataMember = "AccountingCode";

            dataGridView1.Columns[0].Visible = false;
            dataGridView1.Columns[1].HeaderText = "کد حسابداری";
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                database.Connection_Open();
                objCommandBuilder.DataAdapter.Update(objDataSet, "AccountingCode");
                database.Connection_Close();
