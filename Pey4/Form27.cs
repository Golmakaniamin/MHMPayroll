...
namespace Pey4
{
    public partial class Form27 : Form
    {
        ...
        private void Form27_Load(object sender, EventArgs e)
        {
            ...
            database.Connection_Open();
            database.Fill("SELECT * FROM [Tbl_Sherkat_vabaste]", objDataSet, "Tbl_Sherkat_vabaste", true);
            database.Connection_Close();

            dataGridView1.AutoGenerateColumns = true;
            dataGridView1.DataSource = objDataSet;
            dataGridView1.DataMember = "Tbl_Sherkat_vabaste";

            dataGridView1.Columns[0].Visible = false;
            dataGridView1.Columns[1].HeaderText = "کد";
            dataGridView1.Columns[2].HeaderText = "نام شرکت";
            dataGridView1.Columns[3].HeaderText = "لیست";
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                database.Connection_Open();
                objCommandBuilder.DataAdapter.Update(objDataSet, "Tbl_Sherkat_vabaste");
                database.Connection_Close();
